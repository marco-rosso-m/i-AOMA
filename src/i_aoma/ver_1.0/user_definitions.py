# Paths definitions
DATA_FILE = 'DATA/5DOF_fixed_ex.txt' #'DATA/data_tower.pkl' #'DATA/TRAVE1_AF_1cuscino.csv' #'DATA/5DOF_fixed_ex.txt'
RESULTS_PATH = 'RESULTS/5DOF_new' #'RESULTS/tower'
NODESFILE = 'DATA/DATA/nodes.txt' #'DATA/nodes_tower.xlsx' #'DATA/nodes_wood.txt' #'DATA/nodes.txt'
CONNECTIVITYFILE = 'DATA/connectivity.txt' #'DATA/connectivity_tower.xlsx' #'DATA/connectivity_wood.txt' #'DATA/connectivity.txt'
# The following file containts 0 and 1 to attach mode shape component to corresponding DOFs of the geometry
MONITORED_DOF_FILE = 'DATA/nodes_mode_shape_dofs.txt' #'DATA/nodes_mode_shape_dofs_tower.xlsx' # 'DATA/nodes_mode_shape_dofs.txt'
# Problem dimensions, accepted integers 2 or 3 for plotting mode shapes in 2D or 3D structures
N_DIM = 2

# Vibration data info
## [Hz]
SAMPLING_FREQUENCY = 100 #200 #1200 #100
DECIMATION_FACTOR = 5 #40 #2 #5
...
MAX_NUM_MC_SIM_PHASE_1 = 10
MAX_NUM_MC_SIM_PHASE_2 = 50
